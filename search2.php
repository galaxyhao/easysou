...
<link rel="shortcut icon" href="images/yi.png">
...
<iframe frameborder="0" width="100%" height="100%" src="frameset2.php" id="iframe">
</iframe>
<!-- 动态获取调整iframe框架的高度 -->
<script>
...
var xmlHttp;
  function search()
  {
    ...
    var url = "data2.php";
    url = url + "?q1=" + engines1 + "&q2=" + engines2 ;
  ...
  function stateChanged() 
  {
    if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
    {
      ...
      y.getElementById("src1").src = arr[0] + search_key;
      y.getElementById("src2").src = arr[1] + search_key;
    } 
  }
